...
def player1_attack_player2():
    #攻击前
                #呆鹅          #希儿          #渡鸦         #樱莲
    if(iplayer1==10 or iplayer1==9 or iplayer1==6 or iplayer1==5):
    ...
    if(player1.jumpround==0):#未被控制
        ...
        player1.jumpround=0
        print(player1.name+"恢复行动了")

    #攻击后
            #德莉莎          #板鸭
    if(iplayer1==7 or iplayer1==2 ):
        player1skill0(iplayer1)   
    #承伤复活判定
...
def player2_attack_player1():
    #攻击前
                #呆鹅          #希儿          #渡鸦         #樱莲
    if(iplayer2==10 or iplayer2==9 or iplayer2==6 or iplayer2==5):
        player2skill0(iplayer2)
...
#    player2.hp=100
    ...
    while(player1.hp>0 and player2.hp>0):
        #开战前
        if(iplayer1==3 or iplayer1==11):
            player1skill0(iplayer1)
        if(iplayer2==3 or iplayer2==11):
            player2skill0(iplayer2)
        ...
        if(player1.speed>player2.speed):
            ...
            if(player2.hp>0):
                print("round"+str(round)+".1"+player2.name+"剩余血量"+str(player2.hp))
                
                player2_attack_player1()
                
                if(player1.hp>0):
                    print("round"+str(round)+".2"+player1.name+"剩余血量"+str(player1.hp))
                    round+=1
                else:
            ...
            player2_attack_player1()
            if(player1.hp>0):
                print("round"+str(round)+".1"+player1.name+"剩余血量"+str(player1.hp))
                player1_attack_player2()
                if(player2.hp>0):
                    print("round"+str(round)+".2"+player2.name+"剩余血量"+str(player2.hp))
                    round+=1
                else:
                    print("game is over,winner is"+player1.name)
                    player1win+=1
